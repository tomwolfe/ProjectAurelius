...
External validation against published experimental data confirms Spearman ρ = 0.50 for LUMO (N=26, p=0.0095) and ρ = 0.51 for HOMO (N=26, p=0.0076), with positive correlation across all five benchmarked properties (dielectric ρ=+0.8493 p=0.0000, viscosity ρ=+0.8024 p=0.0000, donor number ρ=+0.6956 p=0.0028, HOMO ρ=+0.5115 p=0.0076, LUMO ρ=+0.4985 p=0.0095). The mutation engine achieves 93.3% novel scaffold discovery.
