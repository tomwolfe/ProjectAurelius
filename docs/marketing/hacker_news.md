...
|---|---|---|---|
| Dielectric ε | 23 | +0.3967 | 0.0609 |
| Viscosity η | 23 | +0.7253 | 0.0001 |
| Donor Number | 16 | +0.4074 | 0.1173 |
| HOMO | 26 | +0.5115 | 0.0076 |
| LUMO | 26 | +0.5053 | 0.0085 |

The mutation engine achieves 95.0% novel scaffold discovery rate with a mean score gap of +33.60 over known commercial electrolytes in 5-generation loops.
