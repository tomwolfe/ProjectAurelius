#!/bin/bash
# Aurelius v5.2 Environment Setup Script
# Run this to configure the M5 Pro hard-partitioned memory layout

set -e

echo "=== Aurelius v5.2 Environment Setup ==="
...
echo ""
echo '  # Aurelius v5.2 - M5 Pro hard-partitioned memory'
echo '  export PYTORCH_MPS_ENABLE_ASYNC_COMPILATION=1'
echo '  export MLX_MAX_MEM_CACHE=12G'
echo '  export AURELIUS_VERSION="5.2.0"'
