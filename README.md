...
*Metrics generated by `benchmarks/benchmark_external_validation.py` and `benchmarks/benchmark_reality_check.py`.*
...
| Reality Check: Score gap | Top discoveries − known | +27.95 (discoveries: 84.96, known: 57.00) |
